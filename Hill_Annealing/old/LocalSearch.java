 ...
 */
	...
	if 	(!search)	nextState = nextMove(game);	// next move is where most of the work is done 
	else			nextState = nextMove(game, search, temperature);
...
/************************************* STARTING VERTICAL CHECKS ****************************************/
  ...
  /*decides whether to take a move that results in a lower state */
	...
	double takeRandom = temperature * random1, dontTakeRandom = control * random2;
